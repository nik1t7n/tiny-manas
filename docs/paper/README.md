...
Nikita Nosov · September 4, 2026 · Independent technical report

The manuscript reconstructs E0–E5, O00–O13, the corrected measurement failures,
the quality-followup decision, and the current native RoPE model. It is not a
...
No model training, generation, deployment, corpus rewriting, or historical metric
replacement was performed to write this report. Single-seed uncertainty, adaptive
validation, historical test reuse, allocator sampling, and incompatible timing
denominators are explicit in the manuscript.
...
revision. This task does not publish the manuscript or upload weights.
